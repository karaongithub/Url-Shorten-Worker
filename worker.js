const config = {
  password: "kakaurl", // 管理面板使用密码 // if password != null, then use this config; otherwise, read password from KV.
...
let index_html = "https://karaongithub.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://karaongithub.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
